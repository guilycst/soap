...
public interface EstoqueWS {
     ...
     * @param filtros
     * @return
     *     returns br.caeçum.estoque.cliente.ListaItens
     */
    ...
    @RequestWrapper(localName = "TodosOsItens", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.cae\u00e7um.estoque.cliente.TodosOsItens")
    @ResponseWrapper(localName = "TodosOsItensResponse", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.cae\u00e7um.estoque.cliente.TodosOsItensResponse")
     ...
     * @param parameters
     * @return
     *     returns br.caeçum.estoque.cliente.CadastrarItemResponse
